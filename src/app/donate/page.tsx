...
const Home = () => {
  ...
  // Optimize disconnect logic using useCallback
  const handleDisconnect = useCallback(async () => {
    await disconnect();
    localStorage.removeItem('walletName'); // Clear stored wallet data
  }, [disconnect]);
  ...
  return (
    <>
      ...
      <div className="flex min-h-screen flex-col items-center justify-center bg-custom-bg text-lime-400 font-mono p-4">
        <h1 className="mb-8 text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-lime-400 to-cyan-400">
          RoboCoin ATM
        </h1>
        {/* ATM Body */}
        <div className="relative flex w-[90%] max-w-[1200px] h-[80vh] border border-gray-700 rounded-xl bg-neutral-900 shadow-lg">
          {/* Left Buttons */}
          ...
          <div className="flex-1 flex flex-col items-center justify-center px-6 py-4">
            <h2 className="mb-4 text-3xl text-lime-400 font-bold">Donate</h2>
